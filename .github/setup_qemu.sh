...
case "$ARCH" in
    x86_64)
        QEMU_ARCH="x86_64"
        QEMU_RISCV32_FILE="qemu-riscv32-softmmu-esp_develop_9.2.2_20250228-x86_64-linux-gnu.tar.xz"
        QEMU_XTENSA_FILE="qemu-xtensa-softmmu-esp_develop_9.2.2_20250228-x86_64-linux-gnu.tar.xz"
        ;;
    aarch64 | arm64)
        QEMU_ARCH="aarch64"
        QEMU_FILE="qemu-esp-develop-9.2.2-20250228-linux-aarch64.tar.gz"
        QEMU_RISCV32_FILE="qemu-riscv32-softmmu-esp_develop_9.2.2_20250228-aarch64-linux-gnu.tar.xz"
        QEMU_XTENSA_FILE="qemu-xtensa-softmmu-esp_develop_9.2.2_20250228-aarch64-linux-gnu.tar.xz"
        ;;
    *)
...
apt update
apt install -y libgcrypt20 libglib2.0-0 libpixman-1-0 libsdl2-2.0-0 libslirp0

QEMU_DIR="qemu"

# 2. Download the correct binary
QEMU_RISCV32_URL="https://github.com/espressif/qemu/releases/download/esp-develop-9.2.2-20250228/$QEMU_RISCV32_FILE"
...
QEMU_XTENSA_URL="https://github.com/espressif/qemu/releases/download/esp-develop-9.2.2-20250228/$QEMU_XTENSA_FILE"
